...
@section('contenido')
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
        <div class="bg-cover bg-center h-[25rem] relative"
            ...
            <div class="relative z-10 flex justify-between items-start p-4">
                <h2 class="text-white text-2xl font-bold">{{ $bovino->nombre ?? 'Sin nombre' }}</h2>
                <span
                    class="{{ $colorClass }} {{ $colorClass == 'bg-white' ? 'text-black' : 'text-white' }} text-sm font-semibold tracking-wide uppercase rounded-full px-2 py-1">
                    ID: {{ $bovino->id_interno }}
                </span>
            </div>
        </div>
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="bg-gray-100 p-4 rounded-lg shadow-md">
                    <p class="text-sm font-semibold text-gray-600">Método de preñez</p>
                    <p class="text-base text-gray-900">{{ $bovino->metodo_prenez ?? 'S/M' }}</p>
                </div>

                <div class="bg-gray-100 p-4 rounded-lg shadow-md">
                    <p class="text-sm font-semibold text-gray-600">Color</p>
                    <p class="text-base text-gray-900">{{ $bovino->color_bovino ?? 'S/C' }}</p>
                </div>
