    ...
    <nav class="text-white text-base font-semibold pt-3">
        ...
        <div x-data="{ isActive: false, open: false }">
            <a href="#" @click="$event.preventDefault(); open = !open"
                class="flex items-center py-4 px-6 text-white transition-colors hover:bg-primary-100 nav-item-sidebar {{Route::currentRouteName() == 'bovino.index' ? 'active-nav-link': ''}}"
